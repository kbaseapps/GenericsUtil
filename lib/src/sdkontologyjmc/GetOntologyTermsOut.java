...
public class GetOntologyTermsOut {
    ...
    private Map<String, List<String>> termInfo;
    ...
    @JsonProperty("term_info")
    public void setTermInfo(Map<String, List<String>> termInfo) {
        this.termInfo = termInfo;
    }

    public GetOntologyTermsOut withTermInfo(Map<String, List<String>> termInfo) {
        this.termInfo = termInfo;
        return this;
    }
